...
def SEResNetBottleneck(filters, reduction=16, strides=1, leaky_relu=False, **kwargs):
...
def SEResNeXtBottleneck(filters, reduction=16, strides=1, groups=32, base_width=4, leaky_relu=False, **kwargs):
    bn_params = get_bn_params()
...
def SEBottleneck(filters, reduction=16, strides=1, groups=64, is_first=False, leaky_relu=False, **kwargs):
    bn_params = get_bn_params()
        ...
        for j in range(stage):
            ...
            if i == 0 and j == 0:
                x = residual_block(filters, reduction=model_params.reduction,
                                   strides=1, groups=model_params.groups, is_first=True, leaky_relu=leaky_relu,
                                   **kwargs)(x)

            elif i != 0 and j == 0:
                x = residual_block(filters, reduction=model_params.reduction,
                                   strides=2, groups=model_params.groups, leaky_relu=leaky_relu, **kwargs)(x)
            else:
                x = residual_block(filters, reduction=model_params.reduction,
                                   strides=1, groups=model_params.groups, leaky_relu=leaky_relu, **kwargs)(x)
...
def SEResNet50(input_shape=None, input_tensor=None, weights=None, classes=1000, leaky_relu=False, include_top=True,
               **kwargs):
    return SENet(
...
def SEResNet101(input_shape=None, input_tensor=None, weights=None, classes=1000, leaky_relu=False, include_top=True,
                **kwargs):
    return SENet(
...
def SEResNet152(input_shape=None, input_tensor=None, weights=None, classes=1000, leaky_relu=False, include_top=True,
                **kwargs):
    return SENet(
...
def SEResNeXt50(input_shape=None, input_tensor=None, weights=None, classes=1000, leaky_relu=False, include_top=True,
                **kwargs):
    return SENet(
...
def SEResNeXt101(input_shape=None, input_tensor=None, weights=None, classes=1000, leaky_relu=False, include_top=True,
                 **kwargs):
    return SENet(
...
def SENet154(input_shape=None, input_tensor=None, weights=None, classes=1000, leaky_relu=False, include_top=True,
             **kwargs):
    return SENet(
